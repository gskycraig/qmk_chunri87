...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_BASE] = LAYOUT(       
        ...
        KC_LCTL, KC_LALT, MO(1),      KC_BSPC,          KC_SPC,        MO(2),   KC_RALT,          KC_RCTL),

    [WIN_FN] = LAYOUT( /* Base */
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MPLY,
        KC_TAB,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_BSLS, KC_LBRC, KC_RBRC, KC_SCLN, KC_QUOT, KC_ENT,
        KC_LSFT, KC_NO,   KC_NO,   KC_NO,   KC_MINS, KC_EQL,  KC_COMM, KC_DOT,  KC_UP,            KC_RSFT,
        KC_LCTL, KC_LGUI, KC_NO,     KC_BSPC,         KC_SPC,          KC_LEFT, KC_DOWN,          KC_RGHT  
        ),

    [MAC_BASE] = LAYOUT(  /* Base */
        KC_ESC, KC_GRV,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_PSCR, KC_SCRL, KC_PAUSE, KC_INS,   KC_DEL, KC_MPLY,
        MO(3),   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_CAPS, KC_HOME, KC_PGUP, KC_ENT,
        KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_END,  KC_PGDN,          KC_RSFT,
        KC_LCTL, KC_LALT, KC_NO,     KC_BSPC,          KC_SPC,         KC_NO,   KC_RALT,          KC_RCTL 
        ),
    [MAC_FN] = LAYOUT(  /* FN */
        SCROLL_SW,KC_NO,  IM_BT1,  IM_BT2,  IM_BT3,  IM_2G4,  KC_NO,   IM_USB,  KC_NO,   NK_TOGG,  KC_NO, KC_MPLY,
        KC_NO,   RL_TOG,  RL_HUI,  RL_MOD,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO  , KC_NO,    KC_SD,
        KC_NO,   RGB_TOG, RGB_VAD, RGB_VAI, RGB_MOD, RGB_RMOD,RGB_SPD, RGB_SPI, KC_NO,             EE_CLR,
        KC_NO,   KC_NO,   KC_NO,     KC_NO,            KC_NO,          KC_NO,   KC_NO,             KC_NO     
        )
};

const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
     { ENCODER_CCW_CW(KC_WH_D, KC_WH_U), ENCODER_CCW_CW(KC_VOLU, KC_VOLD)  },
...
bool kc_suspend_flag     = false; 
bool scroll_sw_flag     = false; 
    ...
    switch (keycode) {
        ...
        case KC_SD: {            
            if (record->event.pressed) {
                  ...
                  kc_suspend_flag = true;
            }
        } break;
        case SCROLL_SW: {            
            if (record->event.pressed) {                
                  scroll_sw_flag = !scroll_sw_flag;
            }
        } break;
        case RL_MOD:
            if (record->event.pressed) {
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    {
        rgb_matrix_set_color(60, RGB_MATRIX_MAXIMUM_BRIGHTNESS, RGB_MATRIX_MAXIMUM_BRIGHTNESS, RGB_MATRIX_MAXIMUM_BRIGHTNESS);
    }
