...
#    ifndef IM_BAT_REQ_LEVEL3_VAL
#        define IM_BAT_REQ_LEVEL3_VAL 15
#    endif

#    ifndef IM_BAT_REQ_LEVEL4_VAL
#        define IM_BAT_REQ_LEVEL4_VAL 5
#    endif



#    ifndef IM_BAT_REQ_LEVEL1_COLOR
#        define IM_BAT_REQ_LEVEL1_COLOR 0x00, RGB_MATRIX_BAT_VAL, 0x000
#    endif
...
#    ifndef IM_BAT_REQ_LEVEL4_COLOR
#        define IM_BAT_REQ_LEVE4_COLOR , 0x00, 0x00, RGB_MATRIX_BAT_VAL
#    endif
...
#        endif
        ...
        for (uint8_t i = 0; i < 10; i++) {
            ...
            if (i < (qbat_save / 10)) {
                if (qbat_save >= (IM_BAT_REQ_LEVEL1_VAL)) {
                    rgb_matrix_set_color(mi_index[i], IM_BAT_REQ_LEVEL1_COLOR);
                } else if (qbat_save >= (IM_BAT_REQ_LEVEL2_VAL)) {
                    rgb_matrix_set_color(mi_index[i], IM_BAT_REQ_LEVEL2_COLOR);
              
#                   ifndef IM_BAT_REQ_LEVEL3_VAL

                } else if (qbat_save >= (IM_BAT_REQ_LEVEL3_VAL)) {
