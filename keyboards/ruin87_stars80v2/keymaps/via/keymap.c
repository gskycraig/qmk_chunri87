...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_BASE] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_F12,  KC_PSCR, KC_SCRL, KC_PAUSE,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_INS,  KC_HOME, KC_PGUP,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,  KC_END,  KC_PGDN,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,                   KC_UP,
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                    KC_RALT, KC_RGUI, LAY_WFN, KC_RCTL, KC_LEFT, KC_DOWN,  KC_RGHT),

    [WIN_FN] = LAYOUT( /* Base */
        OS_CLR,  KC_MYCM, KC_WHOM, KC_MAIL, KC_CALC, KC_MSEL, KC_MSTP, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______,
        ...
        OS_SW,   IM_BT1,  IM_BT2,  IM_BT3,  IM_2G4,  IM_USB, _______,  RL_VAI,  RL_VAD,  _______, _______, _______, _______, _______, RL_MOD,  RL_TOG,  _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,                   RGB_VAI,
        _______, GU_TOGG, _______,                   IM_BATQ,                    _______, _______, _______, _______, RGB_SPI, RGB_VAD, RGB_SPD
        ),

    [MAC_BASE] = LAYOUT(  /* Base */
        KC_ESC,  KC_BRID, KC_BRIU, KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_F12,  KC_PSCR, KC_SCRL, KC_PAUSE,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_INS,  KC_HOME, KC_PGUP,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,  KC_END,  KC_PGDN,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,                   KC_UP,
        KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC,                    KC_RGUI ,KC_RALT , LAY_MFN, KC_RCTL, KC_LEFT, KC_DOWN,  KC_RGHT
        ),

    [MAC_FN] = LAYOUT(  /* FN */
        OS_CLR,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_MOD, _______, _______,
        OS_SW,   IM_BT1,  IM_BT2,  IM_BT3,  IM_2G4,  IM_USB, _______,  RL_VAI,  RL_VAD,  _______, _______, _______, _______, _______, RL_MOD,  RL_TOG,  _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,                   RGB_VAI,
        _______, _______, _______,                   IM_BATQ,                   _______, _______, _______, _______, RGB_SPI, RGB_VAD, RGB_SPD
        )
};
...
blink_rgb_t blink_rgbs[RGB_MATRIX_BLINK_COUNT] = {
    ...
    {.index = 37, .interval = 250, .times = 3, .color = {.r = 100, .g = 100, .b = 100}, .blink_cb = NULL},
};
#endif
...
im_lkey_t lkey_define_user[IM_LKEY_COUNT] = {
    ...
    {.keycode = OS_CLR, .hole_time = 5000}, // 参数：按键值，长按时间
};
#endif
        ...
        case OS_SW: {
            if (pressed) {
                if (confinfo.os_mode == WIN_BASE) {
                    ...
                    rgb_matrix_blink_set_color(37, RGB_MATRIX_MAXIMUM_BRIGHTNESS, RGB_MATRIX_MAXIMUM_BRIGHTNESS, RGB_MATRIX_MAXIMUM_BRIGHTNESS);
                    rgb_matrix_blink_set_interval_times(37, 250, 3);
                    rgb_matrix_blink_set(37);
                } else {
