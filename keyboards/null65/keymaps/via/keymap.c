...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT( /* Base */
        OS_CLR,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  IM_BATQ, RGB_MOD, 
        OS_SW,   IM_BT1,  IM_BT2,  IM_BT3,  IM_2G4,  IM_USB,  _______, _______, _______, _______, _______, _______, _______, _______, CH_SW,
    ...
    [MAC_FN] = LAYOUT(  /* FN */
        OS_CLR,  KC_BRID, KC_BRIU, KC_MCTL,LGUI(KC_R), _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, IM_BATQ, RGB_MOD, 
        OS_SW,   IM_BT1,  IM_BT2,  IM_BT3,  IM_2G4,  IM_USB,  _______, _______, _______, _______, _______, _______, _______, _______, CH_SW,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          RGB_SAI, 
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, RGB_VAI, RGB_SAD,         
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    {
        if(confinfo.os_mode == WIN_BASE)
            rgb_matrix_set_color(59 , RGB_MATRIX_MAXIMUM_BRIGHTNESS, RGB_MATRIX_MAXIMUM_BRIGHTNESS, RGB_MATRIX_MAXIMUM_BRIGHTNESS);
        else
